      ...
      <section class="how" aria-labelledby="how-heading">
        ...
        <ol class="how__steps">
          ...
          <li class="how__step">
            ...
            <div class="how__text">
              <p class="how__step-title">Приходите в отделение или вызовите курьера</p>
              <p class="how__step-desc">Для проверки и оценки золотого изделия. Если передаете изделие на оценку через курьера, срок зачисления средств будет увеличен на несколько часов</p>
            </div>
          </li>
          <li class="how__step">
            <div class="how__icon" aria-hidden="true">
